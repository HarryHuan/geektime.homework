...
func (c *userServiceClient) UserInfo(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*UserInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.geekbang.user.UserService/UserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_UserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.geekbang.user.UserService/UserInfo",
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.geekbang.user.UserService",
	...
	Metadata: "homework03/api/user.proto",
}
